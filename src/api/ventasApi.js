...
export const getInfoVentasCafeSeco = async (id_finca, year) => {
      try {
            ...
            console.error(
                  "Error al mostrar la información de ventas de café seco:",
                  error
            );
            throw error;
      }
...
export const getInfoVentasCafeVerde = async (id_finca, year) => {
      try {
            ...
            console.error(
                  "Error al mostrar la información de ventas de café verde:",
                  error
            );
            throw error;
      }
...
export const getInfoVentasPasilla = async (id_finca, year) => {
      try {
            ...
            console.error(
                  "Error al mostrar la información de ventas de pasilla:",
                  error
            );
            throw error;
      }
